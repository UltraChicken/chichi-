import TempToast from './chicken-toast.vue'
...
const chickenToast = {
    install(Vue, options = {}) {
        ...
        Vue.prototype.$mmToast = (message, position) => {
            ...
            if (message) {
                opt.message = message   // 如果有传message，就用所传的message
            }
            if (position) {
                opt.position = position // 如果有传position，则使用所传的position
            }
